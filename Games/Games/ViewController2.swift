...
class ViewController2: UIViewController, UICollisionBehaviorDelegate {
    ...
    func collisionBehavior(_ behavior: UICollisionBehavior, beganContactFor item1: UIDynamicItem, with item2: UIDynamicItem, at p: CGPoint) {
        ...
        if item1.isEqual(ballView) && item2.isEqual(brick){
            ...
            if brickCount == 0 {
                ...
                let doneAction = UIAlertAction(title: "Wanna Play Again?", style: .default) { [self] (action) in
                    ...
                    for brick in self.allBricks{
                        ...
                        self.collisionBehavior.removeItem(brick)
                    }
                }
    ...
    @IBAction func startButton(_ sender: UIButton) {
        ...
        let utterance = AVSpeechUtterance(string: "Game time")
